# Generated by Powerlevel10k configuration wizard on 2020-06-30 at 20:35 PDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_COMMITS_BEHIND )) && res+=" ${clean}${VCS_INCOMING_CHANGES_ICON}${VCS_STATUS_COMMITS_BEHIND}"
